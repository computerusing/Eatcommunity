...
class EditorListActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        floatingActionButton.setOnClickListener {
            // Intent 생성
            val intent = Intent(this@EditorListActivity, WriteActivity::class.java)
    ...
    inner class MyAdapter : RecyclerView.Adapter<MyViewHodler>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHodler {
            return MyViewHodler(LayoutInflater.from(this@EditorListActivity).inflate(R.layout.card_post,
                parent, false))
        }
        ...
        override fun onBindViewHolder(holder: MyViewHodler, position: Int) {
            ...
            holder.itemView.setOnClickListener {
                ...
                val intent = Intent(this@EditorListActivity, DetailActivity::class.java)
