...
class MyReviewActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        floatingActionButton.setOnClickListener {
            // Intent 생성
            val intent = Intent(this@MyReviewActivity, WriteActivity::class.java)
    ...
    inner class MyAdapter : RecyclerView.Adapter<MyViewHodler>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHodler {
            return MyViewHodler(LayoutInflater.from(this@MyReviewActivity).inflate(R.layout.card_post,
                parent, false))
        }
