package com.project.eatapp.Board
...
class InActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "현상금사냥"
        // 하단의 floatingActionButton 이 클릭될때의 리스너를 설정한다.
        floatingActionButton.setOnClickListener {
            // Intent 생성
            val intent = Intent(this@InActivity, WriteActivity::class.java)
    ...
    inner class MyAdapter : RecyclerView.Adapter<MyViewHodler>() {
        ...
        override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHodler {
            return MyViewHodler(LayoutInflater.from(this@InActivity).inflate(R.layout.card_post,
                parent, false))
        }
        ...
        override fun onBindViewHolder(holder: MyViewHodler, position: Int) {
            ...
            holder.itemView.setOnClickListener {
                ...
                val intent = Intent(this@InActivity, DetailActivity::class.java)
